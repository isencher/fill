...
Serves static HTML pages for the web application.
"""
...
# Get static directory (relative to this file)
...
async def mapping_html_page() -> FileResponse:
    """
    Mapping HTML page - serves column-to-placeholder mapping interface.
