...
class TestTemplateSelectionPage:
    ...
    def test_template_list_page_exists(self, page: Page):
        ...
        expect(page.locator("text=发票模板")).to_be_visible()
        expect(page.locator("text=合同模板")).to_be_visible()
    
    def test_template_list_shows_builtin_templates(self, page: Page):
    ...
    def test_template_selection_navigates_to_mapping(self, page: Page):
    ...
    def test_template_upload_option_available(self, page: Page):
        """Should have option to upload custom template."""
        page.goto("http://localhost:8000/templates.html?file_id=test-file-123")
        
        expect(page.locator("text=上传我的模板")).to_be_visible()
...
class TestUploadPageRedirectFix:
    ...
    def test_upload_success_shows_template_selection_button(self, page: Page):
    ...
    def test_upload_redirect_includes_file_id(self, page: Page):
...
class TestMappingConfirmationFlow:
    ...
    def test_mapping_page_shows_preview(self, page: Page):
        ...
        expect(page.locator("text=数据预览")).to_be_visible()
        expect(page.locator("table")).to_be_visible()
    
    def test_mapping_page_requires_confirmation(self, page: Page):
        """Should require explicit confirmation before generating."""
        page.goto("http://localhost:8000/mapping.html?file_id=demo&template_id=demo")
        
        # Should show confirmation modal/section
        expect(page.locator("text=确认生成")).to_be_visible()
        expect(page.locator("text=将生成")).to_be_visible()
    
    def test_missing_parameters_shows_helpful_error(self, page: Page):
        ...
        expect(page.locator("text=请先上传数据文件")).to_be_visible()
        expect(page.locator("text=选择模板")).to_be_visible()  # CTA to fix


class TestDualEntryPoints:
    """Test both workflow entry points work."""

    def test_data_first_entry_point(self, page: Page):
        """User can start by uploading data first."""
        page.goto("http://localhost:8000/")
        
        # Should have data upload option
        expect(page.locator("text=我有数据文件")).to_be_visible()
    
    def test_template_first_entry_point(self, page: Page):
        """User can start by selecting template first."""
        page.goto("http://localhost:8000/")
        
        # Should have template selection option
        expect(page.locator("text=从示例开始")).to_be_visible()
    
    def test_template_first_flow_asks_for_data(self, page: Page):
        ...
        expect(page.locator("text=上传数据文件")).to_be_visible()


class TestSmartMappingSuggestions:
    """Test smart mapping suggestions with confidence levels."""

    def test_high_confidence_mapping_shows_checkmark(self, page: Page):
    ...
    def test_medium_confidence_shows_warning(self, page: Page):
    ...
    def test_low_confidence_requires_manual_selection(self, page: Page):
